...
<body class="login-page" style="background:url(
	'<?php echo base_url('assets_style/image/lib.jpg');?>')no-repeat;background-size:100%;">
<div class="login-box">
	<br/>
      <div class="login-logo">
    <a href="index.php" style="color: Blue;"><b>Perpustakaan</b> <br/><b>Mulia</b></a>
  </div>
  <div id="tampilalert"></div>
  <!-- /.login-logo -->
  <div class="login-box-body" style="border:2px solid #226bbf;">
    <p class="login-box-msg" style="font-size:16px;">Registrasi Anggota Baru</p>
  ...
  <footer>
    <div class="login-box-body text-center bg-blue">
       <a style="color: white;"> Copyright &copy; Perpustakaan Mulia - <?php echo date("Y");?>
    </div>
  </footer>
</div>
<!-- /.login-box -->
