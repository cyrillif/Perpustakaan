...
class Dashboard extends CI_Controller {
	...
	{	
		...
		$this->data['count_pengguna_Petugas']=$this->db->query("SELECT * FROM tbl_login where level = 'Petugas'")->num_rows();
		$this->data['count_pengguna_Anggota']=$this->db->query("SELECT * FROM tbl_login where level = 'Anggota'")->num_rows();
